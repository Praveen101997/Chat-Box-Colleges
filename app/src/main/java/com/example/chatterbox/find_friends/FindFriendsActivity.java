package com.example.chatterbox.find_friends;
...
import com.example.chatterbox.settings.ProfileActivity;
...
//                        View view  = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.users_display_layout);
