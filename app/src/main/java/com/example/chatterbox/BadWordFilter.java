...
public class BadWordFilter {
   ...
   */
  public static String getCensoredText(final String input, final BufferedReader br) {
	  loadBadWords(br);
    if (input == null) {
      return "";
    }
    ...
    Log.d("InputOutput",""+inputToReturn);
    return inputToReturn;
  } // end getCensoredText

  private static void loadBadWords(BufferedReader reader) {
    Log.d("InputOutput",""+"InLoadBadWOrds");
    int readCounter = 0;
    try {
...
//    	     FileReader fr = new FileReader("Word_Filter - Sheet1.csv");
